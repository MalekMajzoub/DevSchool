...
public class Quiz1 extends AppCompatActivity {
    public static final String EXTRA_SCORE1 = "extraScore";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewScore = findViewById(R.id.quiz1_score);

        textViewCountDown = findViewById(R.id.quiz1_countdown);

        textViewQuestion1 = findViewById(R.id.quiz1_question1);
        rbGroup1 = findViewById(R.id.quiz1_radio_group1);
        rb11 = findViewById(R.id.quiz1_radio_button11);
        rb12 = findViewById(R.id.quiz1_radio_button12);
        rb13 = findViewById(R.id.quiz1_radio_button13);

        textViewQuestion2 = findViewById(R.id.quiz1_question2);
        rbGroup2 = findViewById(R.id.quiz1_radio_group2);
        rb21 = findViewById(R.id.quiz1_radio_button21);
        rb22 = findViewById(R.id.quiz1_radio_button22);
        rb23 = findViewById(R.id.quiz1_radio_button23);

        textViewQuestion3 = findViewById(R.id.quiz1_question3);
        rbGroup3 = findViewById(R.id.quiz1_radio_group3);
        rb31 = findViewById(R.id.quiz1_radio_button31);
        rb32 = findViewById(R.id.quiz1_radio_button32);
        rb33 = findViewById(R.id.quiz1_radio_button33);

        buttonConfirm = findViewById(R.id.quiz1_confirm);
            ...
            public void onClick(View v) {
                if (!answered) {
                    if ((rb11.isChecked() || rb12.isChecked() || rb13.isChecked())
                        ...
                        Toast.makeText(Quiz1.this, "You still have answers not selected", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    finishQuiz();
                }
    ...
    private void finishQuiz() {
        ...
        resultIntent.putExtra(EXTRA_SCORE1, score);
